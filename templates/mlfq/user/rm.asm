...
printint(int fd, int xx, int base, int sgn)
{
 ...
 318:	f7 f1                	div    %ecx
 31a:	0f b6 92 b4 06 00 00 	movzbl 0x6b4(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 4a2:	e9 06 ff ff ff       	jmp    3ad <printf+0x45>
          s = "(null)";
 4a7:	bb ad 06 00 00       	mov    $0x6ad,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 544:	a1 28 09 00 00       	mov    0x928,%eax
 ...
 553:	77 10                	ja     565 <free+0x2d>
{
 ...
 57e:	89 08                	mov    %ecx,(%eax)
  freep = p;
 580:	a3 28 09 00 00       	mov    %eax,0x928
}
 585:	5b                   	pop    %ebx
 586:	5e                   	pop    %esi
 587:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 5b8:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
 5bb:	8b 15 28 09 00 00    	mov    0x928,%edx
 ...
 5e3:	eb 70                	jmp    655 <malloc+0xaf>
    base.s.ptr = freep = prevp = &base;
 5e5:	c7 05 28 09 00 00 2c 	movl   $0x92c,0x928
 5ec:	09 00 00 
 5ef:	c7 05 2c 09 00 00 2c 	movl   $0x92c,0x92c
 5f6:	09 00 00 
    base.s.size = 0;
 5f9:	c7 05 30 09 00 00 00 	movl   $0x0,0x930
 600:	00 00 00 
    base.s.ptr = freep = prevp = &base;
 603:	ba 2c 09 00 00       	mov    $0x92c,%edx
 ...
 616:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 619:	89 15 28 09 00 00    	mov    %edx,0x928
      return (void*)(p + 1);
 ...
 63a:	e8 f9 fe ff ff       	call   538 <free>
  return freep;
 63f:	8b 15 28 09 00 00    	mov    0x928,%edx
      if((p = morecore(nunits)) == 0)
 ...
 655:	89 c2                	mov    %eax,%edx
    if(p == freep)
 657:	39 05 28 09 00 00    	cmp    %eax,0x928
